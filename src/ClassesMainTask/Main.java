...
public class Main {
    public static void main(String[] args) {
        ...
        customers.addCustomerToShopList(new SubjectCustomer(4, "Петр", "Ужов", "Владимирович", 444857463, 77742584));
        customers.addCustomerToShopList(new SubjectCustomer(5, "Мария", "Андреева", "Викторовна", 444864384, 77747983));
        customers.addCustomerToShopList(new SubjectCustomer(6, "Дарья", "Жиркова", "Петровна", 444947652, 77741875));
